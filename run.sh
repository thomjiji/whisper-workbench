...
#   -o "usage/geekshootjack/连接音乐Wi-Fi-杨海崧/output/whisper_workbench/skip_postprocess" \
#   -l zh \
#   --backend local \
#   --skip-postprocess

uv run main postprocess \
  --srt "usage/geekshootjack/连接音乐Wi-Fi-杨海崧/output/whisper_workbench/skip_postprocess/杨海崧-音频_first15m_zh.srt" \
  --txt "usage/geekshootjack/连接音乐Wi-Fi-杨海崧/output/whisper_workbench/skip_postprocess/杨海崧-音频_first15m_zh.txt" \
  --llm-correct \
  --llm-backend gemini \
  --glossary-file="usage/geekshootjack/连接音乐Wi-Fi-杨海崧/docs/glossary_full.txt"
