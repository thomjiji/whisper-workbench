...
uv run main postprocess \
  --srt "usage/geekshootjack/连接音乐Wi-Fi-杨海崧/output/skip_postprocess/杨海崧-音频_first10m_zh.srt" \
  --txt "usage/geekshootjack/连接音乐Wi-Fi-杨海崧/output/skip_postprocess/杨海崧-音频_first10m_zh.txt" \
  --split-on-punc \
  --llm-correct \
  --llm-backend gemini \
  --glossary-file="usage/geekshootjack/连接音乐Wi-Fi-杨海崧/docs/glossary_full.txt"
