...
| T-007 | Add FFmpeg music-segment detector script with configurable dB thresholds | in_progress | agent | - | Script accepts media input, supports `>=`/`<=` dB threshold filtering, and outputs timestamped candidate segments with duration |
